...
public class deployMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView size = (TextView)findViewById(R.id.shipSize);
        ...
        if (multiplayer == 1) {
            ...
            game = new Game(ai);
            tv.setText("Enter Position For: " + game.getNextBoatName());
            size.setText("Ship Size: " + game.getNextShipSize());
            ...
            if (message == 1) { // auto generate boats selected
                ...
                TextView startPoint = (TextView)findViewById(R.id.startMsg);
                TextView endPoint = (TextView)findViewById(R.id.endMsg);

                size.setText("");
                generateAgainButton.setText("RANDOMIZE");
            ...
            public void onClick(View v) {
                ...
                if(Coord == 2) {
                    ...
                    if (game.getNumberOfBoats() == 7) {
                        ...
                        int nextSize = game.getNextShipSize();
    ...
    private void placeBoatOnGrid(Boat b) {
        ...
        for (int i = 0; i < points.size(); i++) {
            ...
            button.setBackgroundResource(R.drawable.ship);
        }
    }
