...
public class UserInterface
{
	...
	public ArrayList<String> getPoints(String boatName)
    {
        ...
        String message1 = "Enter starting coordinate for " + boatName + "(E.g \"A,1\"): ";
        String message2 = "Enter ending coordinate for " + boatName + " (E.g \"A,3\"): ";
        ...
        do { // continue with loop until the boat's coordinates have been obtained successfully
            ...
            {
                System.out.println("LOG: ENTERED IF 1: " + partsEnd[0].charAt(0) + " " + partsEnter[0]);
                int distance = (int)partsEnd[1].charAt(0) - (int)partsEnter[1].charAt(0);
            ...
            {
                System.out.println("LOG: ENTERED IF 2");
